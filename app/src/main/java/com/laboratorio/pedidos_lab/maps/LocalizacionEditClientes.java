...
public class LocalizacionEditClientes implements LocationListener {

    ModificarCliente mainActivity;
    TextView tvLatitud, tvLongitud;
    public static String latitud1 = "0", longitud1 = "0";

    public void setMainActivity(ModificarCliente mainActivity, TextView tvLatitud, TextView tvLongitud) {
