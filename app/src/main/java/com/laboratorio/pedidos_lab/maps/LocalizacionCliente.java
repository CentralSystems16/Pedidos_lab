...
public class LocalizacionCliente implements LocationListener {

    OtraPersona mainActivity;
    TextView tvLatitud, tvLongitud;
    public static String latitud1 = "0", longitud1 = "0";

    public void setMainActivity(OtraPersona mainActivity, TextView tvLatitud, TextView tvLongitud) {
