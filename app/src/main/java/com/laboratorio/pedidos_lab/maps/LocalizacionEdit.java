...
public class LocalizacionEdit implements LocationListener {

    ModificarUsuario mainActivity;
    TextView tvLatitud, tvLongitud;
    public static String latitud1 = "0", longitud1 = "0";

    public void setMainActivity(ModificarUsuario mainActivity, TextView tvLatitud, TextView tvLongitud) {
