...
public class ActualizarUsuario {
    ...
    public static class Actualizar extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground (String...params){
            String registrar_url = "http://pedidoslab.6te.net/consultas/actualizarUsuarioCliente.php" + "?id_usuario=" + Login.gIdUsuarioClient + "&id_cliente=" + Login.gIdClienteClient;
            String resultado;
            ...
            try {
                ...
                String idUsuario = String.valueOf(Login.gIdUsuarioClient);
                String idCliente = String.valueOf(Login.gIdClienteClient);

                String data = URLEncoder.encode("id_usuario", "UTF-8") + "=" + URLEncoder.encode(idUsuario, "UTF-8")
